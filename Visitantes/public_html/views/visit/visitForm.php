...
<div class="container">
    ...
    <form id="visitForm" method="POST" autocomplete="off">
        ...
        <div class="mb-2">
            <button type="button" class="btn btn-primary" id="saveVisit">Sumarme</button>
            <button type="button" class="btn btn-secondary" id="resetVisitForm">Restablecer</button>
        </div>
    </form>
