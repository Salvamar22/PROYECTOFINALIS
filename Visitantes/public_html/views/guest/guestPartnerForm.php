...
<div class="container">
  ...
  <form id="guestPartnerForm" method="POST" autocomplete="off">
    <input type="hidden" name="action" value="register_partner_guest">
    <div class="row mb-3">
    ...
    <div class="mb-3">
      <button type="button" class="btn btn-primary" id="savePartnerGuest">Guardar</button>
