...
<div class="container">
    ...
    <div class="container">
        <div class="row mt-2 mb-3 align-items-center">
            <div class="col-8">
                <div class="row">
                    <label for="inputGuestSearch" class="col-sm-3 col-form-label">Buscador:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputGuestSearch" placeholder="Escriba aquí para buscar" aria-label="Escriba aquí para buscar">
                    </div>
                </div>
            </div>
            <div class="col-4">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnGuestExport" class="btn btn-success">Descargar</button>
                </div>
            </div>
        </div>
    </div>
